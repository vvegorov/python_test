...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_name("products[68]").click()
        self.accept_next_alert = True
        driver.find_element_by_name("delete").click()
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Catalog'])[1]/following::span[1]").click()
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Appearance'])[1]/preceding::i[4]").click()
